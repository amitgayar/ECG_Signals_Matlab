...
% hrv= Heart Rate seVariability

% use:[avgHR,meanRR,rmssd,nn50,pNN50,sd_RR,sd_HR,se,pse,average_hrv,hrv]= getECGFeatures(ecg_signal,winsize,wininc)

function [avgHR,meanRR,rmssd,nn50,pNN50,sd_RR,sd_HR,se,pse,average_hrv,hrv]= getECGFeatures(ecg_signal)
...
%% Calculating Sample Entropy
    ...
    sampleEntropy(counter) = SampEn( 2, 0.2, windows{counter}, 1 );
